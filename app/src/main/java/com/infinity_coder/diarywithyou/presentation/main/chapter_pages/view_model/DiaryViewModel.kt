package com.infinity_coder.diarywithyou.presentation.main.chapter_pages.view_model
...
class DiaryViewModel: ViewModel() {
    /**
     * Создаёт pdf документ из списка страниц и кладёт его по указанному пути
     */
